...
template = """apic:
  tenants:
    - name: cl-tal-{n}
      ...
      l3outs:     
        - name: cl-tal-{n}.vrf-01.bgp
          description: fsvi to cl-tal-{n} talos nodes
          vrf: cl-tal-{n}.vrf-01
          domain: cl-tal-{n}.vrf-01.l3out-bgp
          ...
          node_profiles:
            - name: border-leafs
              nodes:
                - node_id: 101
                  router_id: 101.1.{octet3}.1               
                - node_id: 102
                  router_id: 102.1.{octet3}.1   
              bgp:
                ...
                - name: border-leafs
                  interfaces:
                    - node_id: 101
                      ...
                      floating_svi: true
                      paths:
                        - floating_ip: 10.61.{octet3}.13/28
                          physical_domain: titansphere
                      ip: 10.61.{octet3}.11/28
                      ip_shared: 10.61.{octet3}.14/28
                      mtu: 9000
                      bgp_peers:
                        - ip: 10.61.{octet3}.0/28
                          remote_as: {asn}
...
# Generate files for n = 1 to 30
for n in range(1, 31):
    filename = f"tn-cl-tal-{n}.nac.yaml"
    octet3 = 200 + n
    vlan = 500 + n
    asn = 65500 + n
    
    content = template.format(n=n, octet3=octet3, vlan=vlan, asn=asn)
